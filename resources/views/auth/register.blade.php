            ...
            <div class="border-b border-gray-900/10 pb-12">
                ...
                <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <x-form-field>
                        ...
                        <div class="mt-2">
                            <x-form-input name="last_name" id="last_name" placeholder="" required></x-form-input>
                    ...
                    <x-form-field>
                        ...
                        <div class="mt-2">
                            <x-form-input name="email" id="email" placeholder="" required></x-form-input>
                    ...
                    <x-form-field>
                        ...
                        <div class="mt-2">
                            <x-form-input name="password" id="password" placeholder="" required></x-form-input>
